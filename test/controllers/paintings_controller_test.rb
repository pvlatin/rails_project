...
class PaintingsControllerTest < ActionController::TestCase
  ...
  test "should create painting" do
    assert_difference('Painting.count') do
      post :create, painting: { image: @painting.image, name: @painting.name, remote_image_url: @painting.remote_image_url }
    end
  ...
  test "should update painting" do
    patch :update, id: @painting, painting: { image: @painting.image, name: @painting.name, remote_image_url: @painting.remote_image_url }
    assert_redirected_to painting_path(assigns(:painting))
  end
